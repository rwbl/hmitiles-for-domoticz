...
The **HMITiles** framework is a modular layout solution designed to visualize a wide array of smart home infrastructure. 
The **Solar Info Dashboard** included in this repository is the first complete, out-of-the-box reference implementation showing how the framework handles active power management and telemetry data. 
...
![Solar Info Dashboard](images/HMITiles-for-Domoticz-solarinfodashboard-1.png "Solar Info Dashboard") 

![Solar Info Dashboard Trends](images/HMITiles-for-Domoticz-solarinfodashboard-2.png "Solar Info Dashboard Trends") 

![HMITiles Overview](images/HMITiles-for-Domoticz-overview-1.png "HMITiles Overview") 

---

## Example Solar Info Panel
